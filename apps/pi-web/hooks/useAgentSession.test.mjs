...
const source = normalizeNewlines(await readFile(new URL("./useAgentSession.ts", import.meta.url), "utf8"));
const chatWindowSource = normalizeNewlines(await readFile(new URL("../components/ChatWindow.tsx", import.meta.url), "utf8"));
const chatInputSource = normalizeNewlines(await readFile(new URL("../components/ChatInput.tsx", import.meta.url), "utf8"));
const appShellSource = normalizeNewlines(await readFile(new URL("../components/AppShell.tsx", import.meta.url), "utf8"));
